...
router.get('/universes/:id', (req, res, next) => {
    ...
    belongsFunction.getOneByIdUniverse(id)
        .then((result) => {
            return res.send(result);
        })
        .catch((err) => {
...
router.get('/users/:id', (req, res, next) => {
    ...
    belongsFunction.getOneByIdUser(id)
        .then((result) => {
            return res.send(result);
        })
        .catch((err) => {
...
router.put('/', (req, res, next) => {
    ...
    let belongs = {
        idRights : req.body.data.idRights,
        id: req.body.data.id,
        idUniverse: req.body.data.idUniverse
    };

    belongsFunction.updateOne(belongs)
        .then((result) => {
            return res.send(result);
        })
        .catch((err) => {
...
router.delete('/', (req, res, next) => {
    ...
    belongsFunction.deleteOneByIds(belongs)
        .then((result) => {
            return res.send(result);
        })
        .catch((err) => {
