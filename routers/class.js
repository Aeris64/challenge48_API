...
router.get('/universes/:id', (req, res, next) => {
    ...
    classFunction.getAllByIdUniverse(id)
        .then((result) => {
            return res.send(result);
        })
        .catch((err) => {
...
router.post('/', (req, res, next) => {
    ...
    classFunction.createOne(someClass)
        .then((result) => {
            return res.send(result);
        })
        .catch((err) => {
...
router.put('/:id', async (req, res, next) => {
    ...
    await classFunction.getOneById(id)
        .then((result) => {
            if(!someClass.name) someClass.name = result.name;
            if(!someClass.libelle) someClass.libelle = result.libelle;
            if(!someClass.deleted) someClass.deleted = result.deleted;
        })
        .catch((err) => {
            return res.send(new error.NotFoundError(err));
        });

    classFunction.updateOne(id, someClass)
        .then((result) => {
            return res.send(result);
        })
        .catch((err) => {
...
router.delete('/:id', (req, res, next) => {
    ...
    classFunction.deleteOneById(id)
        .then((result) => {
            return res.send(result);
        })
        .catch((err) => {
