...
exports.getAll = async function getAll(){
    return new Promise((resolve, reject) => {
        Client.findAll({attributes: ['id', 'email', 'nom', 'prenom', 'contact', 'ville', 'code_postal', 'rue', 'position_LAT', 'position_LONG']})
        .then(allResult => {
            if(allResult) {
                let finalRes = [];
...
exports.getOneById = async function getOneById(id){
    return new Promise((resolve, reject) => {
        Client.findOne({attributes: ['id', 'email', 'nom', 'prenom', 'contact', 'ville', 'code_postal', 'rue', 'position_LAT', 'position_LONG'],
            where: {
                id:id
            }
        })
